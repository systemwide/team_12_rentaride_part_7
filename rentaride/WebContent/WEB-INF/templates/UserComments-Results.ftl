   ...
   <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Browse User Comments</h1>

          <div class="row placeholders">
			<table>
				<thead>
					<tr>
						<td>Username</td> <td>Comments</td> <td>Vehicle</td> <td> Date</td> <td> Reservation ID</td>
					</tr>
				</thead>
				<tbody>
					<#list comments as comment>
						<tr><td>${comment[1]}</td><td>${comment[2]}</td><td>${comment[3]}</td><td>${comment[4]}</td><td>${comment[5]}</td></tr>
					</#list>
				</tbody>
			<table>
          </div><!-- end row-->
